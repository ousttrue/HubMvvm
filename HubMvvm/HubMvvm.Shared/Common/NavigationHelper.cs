...
namespace HubMvvm.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        RelayCommand<Object> _goForwardCommand;
        ...
        public RelayCommand<Object> GoBackCommand
        {
            get
            {
                ...
                {
                    _goBackCommand = new RelayCommand<Object>(
                        _ => this.GoBack(),
                        () => this.CanGoBack());
                }
        ...
        /// </summary>
        public RelayCommand<Object> GoForwardCommand
        {
            get
            {
                if (_goForwardCommand == null)
                {
                    _goForwardCommand = new RelayCommand<Object>(
                        _ => this.GoForward(),
                        () => this.CanGoForward());
                }

...
namespace HubMvvm.Data
{
    ...
    public class SampleDataGroup
    {
        ...
        RelayCommand<ItemClickEventArgs> m_navigateToItemCommand;
        public ICommand NavigateToItemCommand
        {
            get
            {
                if(m_navigateToItemCommand== null)
                {
                    m_navigateToItemCommand = new RelayCommand<ItemClickEventArgs>(NavigateToItem);
                }
                return m_navigateToItemCommand;
            }
        }

        void NavigateToItem(ItemClickEventArgs e)
        {
            NavigationService.Instance.Navigate(typeof(Views.ItemPage), (Data.SampleDataItem)e.ClickedItem);
        }
        #endregion
    }
